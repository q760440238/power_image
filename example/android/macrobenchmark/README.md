...
loopback HTTP server, so no external network is involved. It records Android frame timing and peak memory for all three
libraries and the count/average duration of
